...
# Create base image with solid dark background
img = Image.new('RGB', (1200, 630), color=(15, 20, 35))
...
try:
    ...
    # Paste image on right side, centered
    x_pos = 700
    y_pos = (630 - 420) // 2
...
print("✅ Clean OG image with profile photo created!")
